    ...
    <div class="row">
      ...
      <div class="col-md-4 pb-4">
        ...
        <div class="social-media">
          @hasoption('facebook')
            <a href="@option('facebook')" target="_blank"><img src="@asset('images/Facebook-Icon.svg')" class="lozad" alt="USB Flash Facebook" width="39" height="39"></a>
          @endoption
          @hasoption('twitter')
            <a href="@option('twitter')" target="_blank"><img src="@asset('images/Twitter-Icon.svg')" class="lozad" alt="USB Flash Twitter" width="39" height="39"></a>
          @endoption
          @hasoption('instagram')
            <a href="@option('instagram')" target="_blank"><img src="@asset('images/Instagram-Icon.svg')" class="lozad" alt="USB Flash Instragram" width="39" height="39"></a>
          @endoption
        </div>
